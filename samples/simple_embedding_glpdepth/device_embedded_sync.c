...
// Update the directory to match where your project currently lives
#include "samples/simple_embedding_glpdepth/simple_embedding_test_bytecode_module_cpu_riscv_64_c.h"
